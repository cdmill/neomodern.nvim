...
function M.generate(colors)
  ...
  separator_open  = ""
  separator_close = ""
  separator_style = { fg = ${dark}, bg = ${blue} }

  mode_normal = { fg = ${dark}, bg = ${blue}, bold = true }
  mode_select = { fg = ${dark}, bg = ${purple}, bold = true }
  mode_unset  = { fg = ${dark}, bg = ${cyan}, bold = true }

  progress_label  = { fg = ${alt}, bold = true }
  progress_normal = { fg = ${alt}, bg = ${selection} }
  progress_error  = { fg = ${dark}, bg = ${error} }
